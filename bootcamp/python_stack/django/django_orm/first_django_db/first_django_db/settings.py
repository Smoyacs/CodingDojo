"""
Django settings for first_django_db project.
...
SECRET_KEY = 'django-insecure-!u6ao4h*t8*s@^yj)hz(1oirg+ijlaczd6k!@rrn^2(=soupg2'
...
ROOT_URLCONF = 'first_django_db.urls'
...
WSGI_APPLICATION = 'first_django_db.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '8320', # contraseña a la que la cambió al instalar Postgres
